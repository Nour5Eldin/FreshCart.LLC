            ...
            <SelectValue placeholder="Select menu item">
              {currentPage && (
                <div className="flex items-center gap-2">
                  <span className="text-tech_blue text-lg">
                    {currentPage.icon}
                  </span>
                  <span className="text-sm font-semibold text-tech_blue">
                    {currentPage.title}
                  </span>
                </div>
              )}
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span
                    className={cn(
                      ...
                      item.href === pathname ? "text-tech_blue" : ""
                    )}
                  >
                    {item.title}
                  </span>
          ...
          >
            <span
              className={cn(
                ...
                item.href === pathname
                  ? "text-tech_blue"
                  : "text-tech_dark/50 group-hover:text-tech_blue"
              )}
            >
              {item?.icon}
            </span>
