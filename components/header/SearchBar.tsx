  ...
  return (
    <div ref={searchRef} className="relative lg:w-full">
      ...
      <button onClick={toggleMobileSearch} className="lg:hidden mt-1.5">
        {showSearch ? (
          <X className="w-5 h-5 text-white hover:text-tech_blue hoverEffect" />
        ) : (
          <Search className="w-5 h-5 text-white hover:text-tech_blue hoverEffect" />
        )}
      </button>
      <form
      ...
      >
        <Input
          placeholder="Search..."
          className="flex-1 rounded-md py-5 focus-visible:ring-0 focus-visible:border-tech_blue bg-tech_white text-tech_dark placeholder:font-semibold placeholder:tracking-wide pr-16"
          value={search}
        ...
        {search ? (
          <X
            onClick={() => setSearch("")}
            className="w-5 h-5 absolute right-3 top-2.5 text-tech_black hover:text-tech_blue hoverEffect cursor-pointer"
          />
        ) : (
            ...
            <div className="bg-tech_bg_color p-4 shadow-lg rounded-md">
              <div className="relative flex items-center">
                ...
                {search ? (
                  <X
                    onClick={() => setSearch("")}
                    className="absolute right-4 w-5 h-5 text-tech_black hover:text-tech_blue hoverEffect cursor-pointer"
                  />
                ) : (
                ...
                <div className="mt-2 bg-tech_white rounded-md shadow-lg overflow-y-auto border border-gray-200 max-h-[50vh]">
                  {loading ? (
                    <div className="flex items-center justify-center px-6 gap-2 py-4 text-center">
                      <Loader2 className="w-5 h-5 animate-spin text-tech_blue" />
                    ...
                    <div className="py-2">
                        ...
                        >
                          ...
                          >
                            ...
                            <div>
                              ...
                              {product.price && (
                                <p className="text-sm font-semibold text-tech_blue mt-0.5">
                                  ${product.price}
                                </p>
                              )}
                            </div>
                      ...
                      <div className="px-4 py-2 bg-gray-50 border-t border-gray-200">
                        <Link
                          ...
                          className="text-sm text-tech_blue font-medium hover:underline"
                        >
                          View all results
                        </Link>
                      </div>
                    ...
                    <>
                      <div className="px-4 py-3 bg-gray-50 border-b border-gray-200">
                        {!search ? (
                          ...
                          <p className="text-sm font-medium text-gray-700">
                            No results for &quot;
                            <span className="text-tech_blue">{search}</span>
                            &quot;
                          </p>
                        )}
                      </div>
