      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <SocialMedia
              ...
              iconClassName="border-tech_dark_color/60 hover:border-tech_blue hover:text-tech_orange"
            ...
            <ul className="space-y-3">
              {quickLinksData?.map((item) => (
                <li key={item?.title}>
                  <Link
                    href={item?.href}
                    className="text-gray-600 hover:text-tech_blue text-sm font-medium hoverEffect"
                  >
                    {item?.title}
                  </Link>
                </li>
        ...
        <div className="py-6 border-t text-center text-sm text-gray-600">
          <p>
            ...
            <span className="text-tech_dark_color font-black tracking-wider uppercase hover:text-tech_blue hoverEffect group font-sans">
                FRESHCAR
              <span className="text-tech_blue group-hover:text-tech_yellow hoverEffect">
                T
              </span>
            </span>
            . All rights reserved.
