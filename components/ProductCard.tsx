    ...
    <div className="text-sm rounded-md group bg-tech_white">
      <div className="relative group overflow-hidden">
        ...
        {(product?.discount as number) > 0 && (
          <p className="absolute top-2 left-0 z-10 text-xs border border-l-0 bg-tech_dark_red text-tech_white font-semibold border-tech_dark_color/50 rounded-r-full px-2 ">
            Save: $
            {Math.round(
      ...
      <div className="p-3 flex flex-col gap-2">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <p
            className={`${product?.stock === 0 ? "text-red-600" : "text-tech_light_green/80 font-semibold"}`}
          >
