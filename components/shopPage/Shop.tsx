  ...
  return (
    <div className="border-t">
      <Container className="mt-5">
            ...
            <div className="flex items-center gap-3">
              {(selectedCategory !== null ||
                ...
                <button
                  ...
                  className="text-tech_blue underline text-sm font-medium hover:text-tech_dark_red hoverEffect"
                >
                  Reset Filters
                </button>
              )}
              <button
                ...
                className="md:hidden flex items-center gap-1 bg-tech_blue text-white px-3 py-1.5 rounded-md"
              >
        ...
        <div className="flex flex-col md:flex-row gap-5 border-t border-t-tech_blue/50">
          ...
          <div
            ...
            pb-5 border-r border-r-tech_blue/50 bg-white
            ...
            <div className="h-auto md:h-[calc(100vh-160px)] overflow-y-auto scrollbar-hide">
              {loading ? (
                <div className="p-10 md:p-20 flex flex-col gap-2 items-center justify-center bg-white rounded-md">
                  <Loader2 className="w-8 h-8 md:w-10 md:h-10 text-tech_blue animate-spin" />
