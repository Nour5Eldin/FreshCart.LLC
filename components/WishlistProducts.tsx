                    ...
                    <tr key={product._id} className="border-b">
                      <td className="py-4 flex items-center gap-2">
                        <X
                          ...
                          size={18}
                          className="hover:text-tech_blue hoverEffect cursor-pointer"
                        />
                        {product?.images && (
                          <Link
                            href={{
                ...
                >
                  <div className="flex justify-between items-start mb-3">
                    ...
                    >
                      <X
                        size={18}
                        className="text-gray-500 hover:text-tech_blue hoverEffect"
                      />
                    </button>
                  </div>
          ...
          <div className="mt-8 flex flex-wrap  gap-4">
            ...
            {favoriteProduct.length > 0 && (
              <Button
                ...
                className="border-tech_dark_red/50 text-tech_dark_color hover:text-tech_dark_red hover:border-tech_dark_red hover:bg-tech_orange/10"
              >
                Reset Wishlist
              </Button>
            )}
