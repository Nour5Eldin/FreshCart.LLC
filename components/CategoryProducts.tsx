      ...
      <div className="flex flex-col md:min-w-40 border bg-tech_white">
        {categories?.map((item) => (
          <Button
            ...
            className={`bg-transparent border-0 p-0 rounded-none text-tech_dark_color shadow-none hover:bg-tech_blue hover:text-white font-semibold hoverEffect border-b last:border-b-0 capitalize ${item?.slug?.current === currentSlug && "bg-tech_blue text-white border-tech_blue"}`}
          >
