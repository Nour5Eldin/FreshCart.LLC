        ...
        >
          ...
          <div className="text-center mb-8">
            <motion.div
              ...
              className="w-20 h-20 bg-tech_blue rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg"
            >
          ...
          <div className="bg-gray-50 rounded-xl p-4 sm:p-6 mb-6 border border-gray-100">
            <h2 className="font-semibold text-lg mb-4 flex items-center">
              <Package className="w-5 h-5 mr-2 text-tech_blue" />
              Order Details
            </h2>
          ...
          <div className="mb-8">
            <h3 className="font-semibold text-lg mb-4 flex items-center">
              <Calendar className="w-5 h-5 mr-2 text-tech_blue" />
              Recent Orders
            </h3>

            {isLoading ? (
              <div className="text-center py-8">
                <div className="inline-block w-6 h-6 border-2 border-tech_blue border-t-transparent rounded-full animate-spin"></div>
              ...
              <div className="space-y-3">
                {(showAllOrders ? orders : orders.slice(0, 3)).map((order) => (
                  <div
                    key={order?._id}
                    className="flex justify-between items-center bg-gray-50 p-3 rounded-lg border border-gray-100 hover:border-tech_blue transition-all duration-200"
                  >
                ...
                {orders.length > 3 && (
                  <button
                    ...
                    className="w-full mt-3 text-tech_blue text-sm font-medium hover:text-tech_blue/80 flex items-center justify-center py-2 border border-gray-100 rounded-lg hover:border-tech_orange/50 transition-all duration-200"
                  >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
            ...
            <Link
              href="/account/orders"
              className="flex items-center justify-center px-4 py-3 font-medium bg-tech_blue text-white rounded-lg hover:bg-tech_blue/90 transition-all duration-300 shadow-md"
            >
