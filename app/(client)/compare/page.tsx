    ...
    <div className="bg-tech_bg_color py-8">
      <Container>
        <div className="flex flex-col gap-1 mb-6">
          <Link
            href="/"
            className="flex items-center text-tech_blue hover:text-tech_blue transition-colors"
          >
            <ChevronLeft size={18} />
                          ...
                          <div className="absolute z-10 left-0 right-0 mt-1 bg-white rounded-md shadow-lg max-h-48 overflow-y-auto border border-gray-200">
                            {loadingSearches[index] ? (
                              <div className="flex items-center justify-center p-2">
                                <Loader2
                                  size={16}
                                  className="animate-spin text-tech_blue"
                                />
                    ...
                    <td key={`name-${index}`} className="p-4 border-l">
                      {product ? (
                        <Link
                          ...
                          className="font-medium text-tech_blue hover:text-tech_blue"
                        >
                          {product.name}
                        </Link>
                      ) : (
                ...
                <tr className="border-b">
                  ...
                  {products.map((product, index) => (
                    <td key={`price-${index}`} className="p-4 border-l">
                      {product ? (
                        <div className="font-semibold text-tech_blue">
                    ...
                    <td key={`action-${index}`} className="p-4 border-l">
                      {product ? (
                        <div className="space-y-2">
                          ...
                          <button
                            className="w-full py-2 px-4 bg-tech_blue text-white text-center rounded hover:bg-tech_blue/90 transition-colors flex items-center justify-center"
                          ...
                          <button
                            className="w-full py-2 px-4 border border-tech_blue text-tech_blue rounded hover:bg-tech_blue hover:text-white transition-colors"
                            onClick={() => clearProduct(index)}
                          >
                            Remove
                          </button>
