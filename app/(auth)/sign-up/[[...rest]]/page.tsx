          ...
          <div className="p-6">
            <SignUp
              appearance={{
                elements: {
                  formButtonPrimary:
                    "bg-tech_blue hover:bg-tech_blue/90 text-white font-semibold py-2 px-4 rounded-md transition-all duration-200",
                  card: "shadow-none",
                  headerTitle: "hidden",
                  headerSubtitle: "hidden",
                  socialButtonsBlockButton:
                    "border border-gray-300 hover:border-tech_blue transition-all duration-200",
                  formFieldInput:
                    "border border-gray-200 focus:border-tech_blue focus:ring-1 focus:ring-tech_blue rounded-md",
                  footerActionLink:
                    "text-tech_blue hover:text-tech_orange/80 font-medium",
                },
              }}
        ...
        <div className="text-center mt-6 text-sm text-gray-600">
          <p>
            ...
            <Link
              ...
              className="text-tech_blue font-semibold hover:underline"
            >
              Sign in
            </Link>
          </p>
